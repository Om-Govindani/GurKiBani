...
const angInputRef = useRef();
  ...
  >
    <GlassSurface
      ...
      saturation={1.6}
      className="min-h-[72px] flex items-center px-2"
    >
          ...
          <div className="flex items-center space-x-2 relative">
            ...
            <div className="relative">
              ...
              {showLangMenu && (
                <div
                  ref={settingsRef}
                  className="absolute right-0 top-8 bg-zinc-900 text-white border border-zinc-700 rounded-md shadow-lg w-48 z-60"
                >
                  {/* Default options */}
