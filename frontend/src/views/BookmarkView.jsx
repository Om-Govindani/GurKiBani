    ...
    return (
        <div className="relative min-h-screen w-full bg-neutral-900 flex-col px-2 py-5 ">
            ...
            <div className="h-fit mx-auto max-w-3xl mt-[20px] overflow-y-scroll">
                ...
                {bookmarks.length===0 ? <EmptyPage title={"No Bookmark Found"} content={"you haven't bookmarked any Shabad yet"} /> : 
                ...
                return (
                    <div key={highlightId} className={`flex flex-row`}>
                        ...
                        >
                            {language!=="hindi" && <div className="font-gurmukhi text-xl text-violet-50 pr-12">{verse[0]}</div>}
                            {language!=="gurmukhi" &&<div className="font-hindi text-lg text-orange-200 pr-12">{verse[1]}</div>}
